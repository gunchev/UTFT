...
//  - note 1: LED can be connected to 3.3V or 5V, so that Backlight will be always on.
//  - note 2: RST can be connected to MCU reset pin, to save a IO pin. (MCU Micro Controller Unit)
//  - note 3: CS  can be connected to GND, So that Chip Sellect will be always Enable.
************************************************************************************/
